...
This repository provides all the tooling to manage the `staging` account infrastructure on AWS. It distributes a single docker container which bundles the entire tool-chain and infrastructure as code necessary to administer the account.

## Acount Details

| Property       | Value                                                                                                                         |
| -------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| AWS Account ID | 377231773819                                                                                                             |
| Account Email  | ops+staging@ryanjarv.sh                                                                                                      |
| Login URL      | <https://signin.aws.amazon.com/switchrole?account=377231773819&roleName=OrganizationAccountAccessRole&displayName=rjsh-staging-admin> |
| Namespace      | rjsh                                                                                                                  |
| Stage          | staging                                                                                                                      |
...
Here is the list of some of the tools we use to provision `staging.ryanjarv.sh` infrastructure in order to facilitate cloud fabrication and administration:
...
```bash
/usr/local/bin/staging.ryanjarv.sh
```

**NOTE (a):** You can just run `staging.ryanjarv.sh`, if your `PATH` contains `/usr/local/bin`
